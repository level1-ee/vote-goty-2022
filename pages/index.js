  ...
  return (
    <div className="max-w-md mx-auto pt-9">
      ...
      <a
        ...
        className=""
      >
        <Image className="mx-auto" src={logo} alt="Level1.ee" priority />
      </a>
      <h1 className="mb-8 text-lg flex leading-none text-violet-400 uppercase slashed-zero justify-center">
        <span className="text-[70px] mr-4">2022</span>{" "}
        <span className="top-[10px] relative text-violet-200">
          aasta
          <br /> mängu
          <br /> valimine
        </span>
      ...
      {formIsVisible ? (
        ...
        <div className="text-center text-xl font-bold p-6">{message}</div>
      )}
    </div>
  );
}
